...
type LayoutRouteId = RouteId | "/" | "/[user]" | "/bandbrowser" | "/login" | "/myband/[band]" | "/registration/band" | "/registration/user" | null
type LayoutParams = RouteParams & { user?: string; band?: string }
