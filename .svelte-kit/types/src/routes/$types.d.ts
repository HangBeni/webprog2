...
type LayoutRouteId = RouteId | "/" | "/bandbrowser" | "/login" | "/myband/[band]" | "/registration/band" | "/registration/user" | "/[user]" | null
type LayoutParams = RouteParams & { band?: string; user?: string }
